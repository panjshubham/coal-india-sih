        ...
        <header className="flex items-center justify-between h-16 px-4 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 lg:px-8">
          ...
          <div className="flex-1 flex items-center justify-end gap-3 sm:gap-4">
            ...
            <button 
              ...
              className="p-2 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors flex items-center gap-2 font-bold text-xs uppercase"
              title="Toggle Language (EN/HI)"
            >
              <Languages className="w-5 h-5" />
              <span className="hidden sm:inline">{i18n.language.startsWith('hi') ? 'HI' : 'EN'}</span>
            </button>
            <div className="h-6 w-px bg-gray-300 dark:bg-gray-600 hidden sm:block"></div>
            ...
            <Link to="/profile" className="flex items-center gap-3 p-1.5 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700/60 transition-colors group">
              <div className="text-right hidden sm:block leading-tight">
                ...
                <p className="text-xs text-amber-600 dark:text-amber-400 font-mono">Sec: {profile.secondaryPhone}</p>
              </div>
