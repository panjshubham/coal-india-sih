  ...
  return (
    <div className="h-full w-full text-slate-100 select-none relative bg-[#060913] min-h-screen overflow-hidden">
      ...
      <header className="absolute top-7 inset-x-0 z-50 flex flex-col items-center justify-center pointer-events-none">
        <div className="flex items-center gap-5 px-6 py-2 rounded-full border border-white/15 bg-[#0e172a]/80 backdrop-blur-md shadow-2xl pointer-events-auto">
          <div className="flex items-center gap-2.5">
            <svg className="w-6 h-6 text-amber-700 dark:text-amber-400" fill="currentColor" viewBox="0 0 64 64">
            ...
            <div className="flex flex-col text-left">
              <span className="font-national text-[10px] tracking-[0.2em] font-bold text-slate-900 dark:text-white uppercase leading-tight">सत्यमेव जयते</span>
              <span className="text-[9px] tracking-[0.18em] font-medium text-slate-700 dark:text-slate-300 uppercase">Govt. of India</span>
            </div>
          </div>
          <div className="h-4 w-px bg-white/20"></div>
          <div className="flex items-center gap-2.5">
            <div className="w-6 h-6 rounded-sm border border-amber-400/40 bg-amber-200 dark:bg-amber-500/20 flex items-center justify-center">
      ...
      <div className="absolute top-7 right-7 z-50 flex items-center gap-3">
        <button 
          onClick={toggleSlide}
          className="group flex items-center gap-2.5 px-3.5 py-1.5 rounded-full border border-white/20 bg-[#0e172a]/80 backdrop-blur-md hover:border-amber-400/60 hover:bg-[#152238]/90 transition text-xs font-mono-tech text-slate-800 dark:text-slate-200 shadow-xl cursor-pointer"
        >
          <span className="w-2 h-2 rounded-full bg-amber-400 animate-pulse"></span>
          <span className="tracking-wider">SLIDE {currentSlide}/3 (Click to switch)</span>
          <svg className="w-3.5 h-3.5 text-slate-600 dark:text-slate-400 group-hover:text-amber-300 transition transform group-hover:translate-x-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className={`slide-layer absolute inset-0 w-full h-full ${currentSlide === 1 ? 'active' : 'inactive'}`}>
        ...
        <div className="relative z-20 h-full w-full flex items-center justify-center px-6">
          <div className="localized-text-backing max-w-4xl w-full mx-auto px-8 py-14 rounded-3xl flex flex-col items-center text-center">
            ...
            <h1 className="fade-stagger-2 font-serif-display hero-text-shadow text-7xl sm:text-8xl md:text-9xl font-normal tracking-[-0.03em] text-slate-900 dark:text-white leading-none mb-6">
            ...
            <div className="fade-stagger-3 hero-subtext-shadow mt-7 flex flex-wrap items-center justify-center gap-3.5 text-[11px] sm:text-xs tracking-[0.18em] uppercase text-slate-800 dark:text-slate-200 font-mono-tech">
      ...
      <section className={`slide-layer absolute inset-0 w-full h-full ${currentSlide === 2 ? 'active' : 'inactive'}`}>
        ...
        <div className="relative z-20 h-full w-full flex items-center justify-center px-6">
          <div className="localized-text-backing max-w-4xl w-full mx-auto px-8 py-14 rounded-3xl flex flex-col items-center text-center">
            ...
            <h2 className="fade-stagger-2 font-serif-display hero-text-shadow text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-normal tracking-[-0.02em] text-slate-900 dark:text-white leading-tight mb-6">
              Centralized.<br />
            ...
            <div className="fade-stagger-3">
              <button onClick={toggleSlide} className="inline-flex items-center gap-2.5 px-6 py-2.5 rounded-full border border-amber-400/60 bg-[#0e172a]/85 backdrop-blur-md hover:bg-amber-200 dark:bg-amber-500/20 text-amber-300 hover:text-amber-200 transition text-xs font-mono-tech tracking-[0.18em] uppercase shadow-2xl cursor-pointer">
                <span>View Command Telemetry</span>
                <svg className="w-4 h-4 text-amber-700 dark:text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M14 5l7 7m0 0l-7 7m7-7H3" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg>
              </button>
            </div>
          </div>
        </div>
      ...
      <section className={`slide-layer absolute inset-0 w-full h-full ${currentSlide === 3 ? 'active' : 'inactive'}`}>
        ...
        <div className="relative z-20 h-full w-full flex items-center justify-center px-6">
          <div className="localized-text-backing max-w-4xl w-full mx-auto px-8 py-14 rounded-3xl flex flex-col items-center text-center">
            ...
            <h2 className="fade-stagger-2 font-serif-display hero-text-shadow text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-normal tracking-[-0.02em] text-slate-900 dark:text-white leading-tight mb-6">Built for <span className="italic font-light text-amber-100/95">Every Mine.</span></h2>
            ...
            <div className="fade-stagger-3 flex flex-wrap items-center justify-center gap-3.5 text-[11px] sm:text-xs tracking-[0.18em] uppercase text-slate-800 dark:text-slate-200 font-mono-tech">
              <button onClick={handleComplete} className="inline-flex items-center gap-2.5 px-6 py-2.5 rounded-full border border-amber-400/60 bg-[#0e172a]/85 backdrop-blur-md hover:bg-amber-200 dark:bg-amber-500/20 text-amber-300 hover:text-amber-200 transition text-xs font-mono-tech tracking-[0.18em] uppercase shadow-2xl cursor-pointer">
      ...
      <footer className="absolute bottom-0 inset-x-0 z-50 pointer-events-none pb-5 px-8 bg-gradient-to-t from-black/80 via-black/40 to-transparent pt-8">
        <div className="max-w-6xl mx-auto flex flex-col gap-2.5 pointer-events-auto">
          <div className="flex items-center justify-between text-[11px] font-mono-tech text-slate-800 dark:text-slate-200 tracking-[0.16em] uppercase hero-subtext-shadow">
            <div className="flex items-center gap-2.5">
            ...
            <div className="hidden sm:flex items-center gap-6 text-slate-700 dark:text-slate-300">
