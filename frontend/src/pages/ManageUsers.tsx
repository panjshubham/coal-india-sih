...
Login Portal: ${window.location.origin}/login`;
  ...
  const getRoleBadge = (userRole: string) => {
    switch (userRole) {
      case 'corporate':
        return (
          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold bg-amber-100 dark:bg-amber-500/10 text-amber-700 dark:text-amber-400 border border-amber-400 dark:border-amber-500/30">
            <Building2 className="w-3.5 h-3.5" /> Corporate Admin
          </span>
        );
      case 'mine_official':
        return (
          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold bg-emerald-100 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-400 dark:border-emerald-500/30">
            <HardHat className="w-3.5 h-3.5" /> Mine Official
          </span>
        );
      case 'regulator':
        return (
          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold bg-blue-100 dark:bg-blue-500/10 text-blue-700 dark:text-blue-400 border border-blue-400 dark:border-blue-500/30">
            <FileCheck className="w-3.5 h-3.5" /> DGMS Regulator
          </span>
        );
      default:
        return (
          <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-slate-500/10 text-slate-600 dark:text-slate-400 border border-slate-500/30">
            {userRole}
          </span>
        );
    }
    ...
    <div className="p-4 sm:p-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span className="px-2.5 py-0.5 rounded text-[10px] font-mono font-bold tracking-widest uppercase bg-amber-100 dark:bg-amber-500/10 text-amber-700 dark:text-amber-400 border border-amber-300 dark:border-amber-500/20">
              Corporate HQ Administration
            </span>
            <span className="text-xs text-slate-600 dark:text-slate-400 font-mono">• DGMS Access Control</span>
          </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <div className="p-4 rounded-xl border border-[var(--cg-border)] bg-[var(--cg-surface)] flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-amber-100 dark:bg-amber-500/10 flex items-center justify-center text-amber-700 dark:text-amber-400">
            <Users className="w-5 h-5" />
          </div>
          <div>
            <p className="text-[11px] font-mono uppercase text-slate-600 dark:text-slate-400">Total Users</p>
            <p className="text-xl font-bold text-[var(--cg-text-primary)]">{users.length}</p>
          </div>
        </div>

        <div className="p-4 rounded-xl border border-[var(--cg-border)] bg-[var(--cg-surface)] flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-emerald-100 dark:bg-emerald-500/10 flex items-center justify-center text-emerald-700 dark:text-emerald-400">
            <HardHat className="w-5 h-5" />
          </div>
          <div>
            <p className="text-[11px] font-mono uppercase text-slate-600 dark:text-slate-400">Mine Officials</p>
        ...
        <div className="p-4 rounded-xl border border-[var(--cg-border)] bg-[var(--cg-surface)] flex items-center gap-3">
          ...
          <div>
            <p className="text-[11px] font-mono uppercase text-slate-600 dark:text-slate-400">Corporate HQ</p>
            <p className="text-xl font-bold text-[var(--cg-text-primary)]">
        ...
        <div className="p-4 rounded-xl border border-[var(--cg-border)] bg-[var(--cg-surface)] flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-blue-100 dark:bg-blue-500/10 flex items-center justify-center text-blue-700 dark:text-blue-400">
            <FileCheck className="w-5 h-5" />
          </div>
          <div>
            <p className="text-[11px] font-mono uppercase text-slate-600 dark:text-slate-400">Regulators</p>
            <p className="text-xl font-bold text-[var(--cg-text-primary)]">
      ...
      <div className="p-4 rounded-xl border border-[var(--cg-border)] bg-[var(--cg-surface)] flex flex-col sm:flex-row gap-3 items-center justify-between">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <span className="text-xs text-slate-600 dark:text-slate-400 whitespace-nowrap">Filter Role:</span>
          <select
            value={roleFilter}
      ...
      <div className="rounded-xl border border-[var(--cg-border)] bg-[var(--cg-surface)] overflow-hidden shadow-sm">
        {loading ? (
          <div className="py-20 flex flex-col items-center justify-center text-slate-600 dark:text-slate-400">
          ...
          <div className="py-16 text-center text-slate-600 dark:text-slate-400">
            <Users className="w-10 h-10 mx-auto mb-3 opacity-40 text-slate-700 dark:text-slate-500" />
            <p className="text-sm font-semibold">No users match the criteria</p>
            <p className="text-xs text-slate-700 dark:text-slate-500 mt-1">Try adjusting the search or role filter</p>
          </div>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-[var(--cg-border)] text-[10px] font-mono uppercase tracking-wider text-slate-600 dark:text-slate-400 bg-[var(--cg-surface-high)]">
                  ...
                  <tr key={user.id} className="hover:bg-[var(--cg-surface-high)]/50 transition-colors">
                    <td className="py-3.5 px-4">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-amber-100 dark:bg-amber-500/10 border border-amber-300 dark:border-amber-500/20 text-amber-700 dark:text-amber-400 font-bold flex items-center justify-center text-xs shrink-0">
                          {user.name.split(' ').map(n => n[0]).slice(0, 2).join('')}
                        </div>
                        <div>
                          <p className="font-semibold text-[var(--cg-text-primary)]">{user.name}</p>
                          <p className="text-[11px] font-mono text-slate-600 dark:text-slate-400">{user.email}</p>
                        </div>
                      </div>
                    </td>
                    <td className="py-3.5 px-4">
                    ...
                    <td className="py-3.5 px-4">
                      {user.role === 'mine_official' ? (
                        user.mines ? (
                          <div>
                            <p className="font-semibold text-emerald-700 dark:text-emerald-400">{user.mines.name}</p>
                    ...
                    <td className="py-3.5 px-4">
                      <span className="inline-flex items-center gap-1.5 text-emerald-700 dark:text-emerald-400 text-[11px] font-mono">
          ...
          <div className="relative w-full max-w-lg rounded-2xl border border-[var(--cg-border)] bg-[var(--cg-surface)] p-6 sm:p-8 shadow-2xl space-y-6">
            ...
            <div className="flex items-start justify-between border-b border-[var(--cg-border)] pb-4">
              ...
              <button
                ...
                className="text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:text-white p-1 rounded-lg hover:bg-[var(--cg-surface-high)]"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            {formError && (
              <div className="p-3 rounded-lg bg-red-100 dark:bg-red-500/10 border border-red-400 dark:border-red-500/30 text-red-700 dark:text-red-400 text-xs flex items-center gap-2">
            ...
            <form onSubmit={handleCreateUser} className="space-y-4">
              ...
              {role === 'mine_official' && (
                <div className="p-3 rounded-lg bg-amber-50 dark:bg-amber-500/5 border border-amber-300 dark:border-amber-500/20 space-y-1">
                  <label className="block text-xs font-bold uppercase tracking-wider text-amber-700 dark:text-amber-400 mb-1">
                    Assigned Mine Jurisdiction <span className="text-red-700 dark:text-red-400">*</span>
                  </label>
                  <select
                    required
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-[var(--cg-border)]">
                <button
                  type="button"
                  onClick={() => setIsAddModalOpen(false)}
                  className="px-4 py-2 text-xs font-semibold text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:text-white rounded-lg hover:bg-[var(--cg-surface-high)] transition-colors"
                >
                  Cancel
                </button>
                <button
      ...
      {provisionedCreds && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm">
          <div className="relative w-full max-w-md rounded-2xl border border-emerald-400 dark:border-emerald-500/30 bg-[var(--cg-surface)] p-6 sm:p-8 shadow-2xl space-y-5">
            
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-emerald-100 dark:bg-emerald-500/10 border border-emerald-400 dark:border-emerald-500/30 flex items-center justify-center text-emerald-700 dark:text-emerald-400 shrink-0">
            ...
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 space-y-2.5 font-mono text-xs">
              <div className="flex justify-between border-b border-slate-200 dark:border-slate-800 pb-1.5">
                <span className="text-slate-600 dark:text-slate-400">Name:</span>
                <span className="text-slate-800 dark:text-slate-200 font-semibold">{provisionedCreds.name}</span>
              </div>
              <div className="flex justify-between border-b border-slate-200 dark:border-slate-800 pb-1.5">
                <span className="text-slate-600 dark:text-slate-400">Email:</span>
                <span className="text-amber-700 dark:text-amber-400 font-semibold">{provisionedCreds.email}</span>
              </div>
              <div className="flex justify-between border-b border-slate-200 dark:border-slate-800 pb-1.5">
                <span className="text-slate-600 dark:text-slate-400">Initial Password:</span>
                <span className="text-emerald-700 dark:text-emerald-400 font-semibold">{provisionedCreds.password}</span>
              </div>
              <div className="flex justify-between border-b border-slate-200 dark:border-slate-800 pb-1.5">
                <span className="text-slate-600 dark:text-slate-400">Role:</span>
                <span className="text-slate-800 dark:text-slate-200 uppercase">{provisionedCreds.role}</span>
              </div>
              {provisionedCreds.mineName && (
                <div className="flex justify-between">
                  <span className="text-slate-600 dark:text-slate-400">Assigned Mine:</span>
                  <span className="text-slate-800 dark:text-slate-200">{provisionedCreds.mineName}</span>
                </div>
              )}
            </div>
            ...
            <div className="flex items-center gap-3 pt-2">
              <button
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 py-2.5 rounded-lg border border-amber-500/40 bg-amber-100 dark:bg-amber-500/10 hover:bg-amber-200 dark:bg-amber-500/20 text-amber-700 dark:text-amber-400 font-bold text-xs transition-colors cursor-pointer"
              >
